...
export default function Footer() {
  return (
    <footer className="mt-16 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/Analytics"
                  className="text-zinc-500 dark:text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors"
                >
                  Analýzy
                </Link>
              </li>
